...
class Hotel:
    ...
    def list_available_rooms(self):
        ...
        return [
            ...
            for num, info in self.rooms.items()
            if not info["booked"]
        ]

    def book_room(self, room_no, guest_name, contact_email, contact_number, check_in, check_out):
        if room_no not in self.rooms or self.rooms[room_no]["booked"]:
        ...
        try:
            ...
            room_price = self.rooms[room_no]["price"]
            tax = room_price * nights * self.tax_rate
    ...
    def confirm_booking(self, booking, payment_method):
        self.rooms[booking["room"]]["booked"] = True
    ...
    def delete_booking(self, room_no):
...
class HotelBookingApp:
    ...
    def book_room(self):
        ...
        def next_payment():
            ...
            try:
                ...
                booking, error = self.hotel.book_room(room_no, guest, email, contact_number, check_in, check_out)
                if error:
    ...
    def payment_widget(self, booking):
        ...
        def confirm_payment():
            ...
            result = self.hotel.confirm_booking(booking, payment_method)
    ...
    def delete_booking(self):
        ...
        def delete():
            try:
                ...
                result = self.hotel.delete_booking(room_no)
    ...
    def view_bookings(self):
        bookings = self.hotel.view_bookings()
